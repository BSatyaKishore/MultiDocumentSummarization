...
public abstract class MultSumBase
{
  ...
  public double L1(HashSet<Integer> S, double[][] w, Double alpha, Double a)
  {
    if(alpha == null)
  ...
  /*  public double R1(HashSet<Integer> S, double[][] w, int[] clustering, int K)
  {
    int N = w.length;
    double res = 0.0;
    for (int k = 0; k != K; ++k)
   ...
   * 
   */
  public static double R1Super(HashSet<Integer> S, double[][] w, Collection<int[]> clusterings, int K)
  {
    double res = 0.0;
  ...
  public static double[][] getSimilaritiesFromFile(String similarityMatrixFileName)
  {
  ...
  public static double[] getWeightsFromFile(String weightsFileName)
  {
    double[] weights = null;
  ...
  public double[][] getDissimilarities(double[][] similarities)
  {
  ...
  public static int[] getClustering(DocMatrices mp, int K)
  {
    return getClusteringCluto(mp.similarities, K);
  }
  /*  public int[] getClusteringKMedians(double[][] distances, int K)
  {
  ...
  public static int[] getClusteringCluto(double[][] adjacencies, int K)
  {
    int[] clustering = null;
  ...
  public static int[] getClusteringByVectors(double[][] sentenceVectors, int K, String vectorFileName, String docName)
  {
    int[] clustering = null;
    ...
    //System.out.println(vectorFileName);
   ...
   * 
   */
  public DocMatrices getAverageMatrix(DocMatrices[] ms, double[] weights, int weightOffset)
  {
    if(ms.length == 1)
      return ms[0];
    double[][] avgSim = null;
  ...
  public DocMatrices getLpNormAggregateSimilarities(DocMatrices[] ms, double p)
  {
    if(ms.length == 1)
      return ms[0];
  ...
  public DocMatrices getMultipliedAggregateSimilarities(DocMatrices[] ms)
  {
    if(ms.length == 1)
      return ms[0];
  ...
  public DocMatrices getMinMatrix(DocMatrices[] ms)
  {
    return getMinMaxMatrix(ms, false);
  }

  public DocMatrices getMaxMatrix(DocMatrices[] ms)
  {
    return getMinMaxMatrix(ms, true);
  }

  public DocMatrices getMinMaxMatrix(DocMatrices[] ms, boolean max)
  {
    if(ms.length == 1)
      return ms[0];
    double[][] aggregateSim = null;
  ...
  public double maxOrMin(double d1, double d2, boolean max)
  {
    if(max)
  ...
  public class DocMatrices
  {
    ...
    public DocMatrices(double[][] sentenceSimilarities, double[][] sentenceDistances, double[][] sentenceVectors)
    {
      ...
      //System.out.println("printing sentence vectors");
      //System.out.println(Arrays.deepToString(sentenceVectors));
    }
  }

  public List<Map<String, Integer>> getSentencesAsBags(HashSet<String> stopwords, List<List<String>> sentencesLists, HashMap<String, String> wordClusterId, Collection<Flags> flags, HashMap<String, Double> idfs)
  {
    List<Map<String, Integer>> sentenceBagList = new ArrayList<Map<String, Integer>>();
    //System.out.println("Called Sentence As Bag");
    //System.out.println(sentencesLists);
    for(int i = 0; i < sentencesLists.size(); i++ )// List<String> sentences: sentencesLists)
    {
      List<String> sentences = sentencesLists.get(i);
      //System.out.println("New Doc");
      //System.out.println(sentences);
      for(int j = 0; j < sentences.size();j++)//String sentence: sentences)
      {
    ...
    //System.out.println("Returned Sentence As Bag");
    return sentenceBagList;
  }

  public static HashMap<String, String> getWordClusters(String wordClusterFileName)
  {
  ...
  public static int charactersLength(Collection<Integer> selected, List<String> sentences)
  {
    int bytes = 0;
  ...
  public static int wordsLength(Collection<Integer> selected, List<String> sentences)
  {
    int bytes = 0;
    for(Integer i: selected)
    {
  ...
  public static boolean summaryIsTooShort(Collection<Integer> selected, List<String> sentences, LengthUnit lengthUnit, int summarySize)
  {
  ...
  public boolean summaryIsTooLong(Collection<Integer> selected, List<String> sentences, LengthUnit lengthUnit, int summarySize)
  {
    if(lengthUnit == LengthUnit.CHARACTERS)
      return charactersLength(selected, sentences) > summarySize;
      else if(lengthUnit == LengthUnit.WORDS)
  ...
  public void saveLinTFIDFMatrix(double[][] similarities, String documentIdentifier) throws IOException
  {
