...
{
  public static final String USAGE_STRING = "Usage: <command> --matrix-file <filename1> [--matrix-file <filename2> [--matrix-file <filename3> [...]]] \n" +
  ...
  public static final String EXPLANATION_STRING = "(Either at least one matrix file or a document file must be present.)\n" +
      "(If document file is a directory, I will try to summarize all documents within.)\n";



  public static final double A                    = 5.0;
  //  public static final double ALPHA                = 0.75f; //LIn-bilmes: alpha = a/N
  public static final double DEFAULT_LAMBDA       = 6.0;
  public static final double LINBILMES_CONSTANT_R = 0.3;
  
  public static final String[] FORBIDDEN_PRONOUNS = {"he", "she", "they"};

  public static final double DISCONNECT_FRACTION = 0.4;
  ...
  public static void main(String[] args)
  {
    ...
    if(matrixFileNames.size() > 0)
    {
      ...
      System.out.println("Called Summary a");
  ...
  public MultSum(List<String> matrixFileNames,
      ...
      String idfVectorsFileName)
  {
    System.out.println("matrix File Names");
    System.out.println(matrixFileNames);
    ...
    if(matrixFileNames == null && false ) //flags.contains(Flags.OPTION_SAVE_MATRICES))
    {
      try
      {
    ...
    if (false){
      ...
      System.out.println(Arrays.deepToString(sentenceVectorsForClustering));
      System.out.println(idfVectorsFileName);
      System.out.println();
      System.out.println();
      System.out.println();
  ...
  public static List<String> getSentencesList(String documentFileName)
  {
  ...
  public static List<List<String>> getSentencesLists(String documentFileName)
  {
  ...
  public DocMatrices getDefaultSentenceSimilarities(String stopwordsFilename, List<List<String>> sentencesLists, String wordClusterFileName, Collection<Flags> flags, HashMap<String, Double> idfs)
  {
    ...
    //System.out.println(sentencesBags.size());
  ...
  public static HashSet<Integer> getDisconnected(double[][] m)
  {
  ...
  public void selectSentences(int summarySize, DocMatrices[] matrices, double lambda, List<String> sentences, LengthUnit lengthUnit, Collection<Flags> flags, double[] weights, double[][] sentenceVectorsForClustering, String idfVectorFileName, String docName)
  {
...
//    }
  ...
  public static HashSet<Integer> getPronounSentences(List<String> sentences)
  {
  ...
  public DocMatrices getAggregateMatrix(DocMatrices[] ms, double[] weights, int weightOffset, Collection<Flags> flags)
  {
  ...
  public static double getDefaultLambda()
  {
