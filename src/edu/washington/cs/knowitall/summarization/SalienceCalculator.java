...
/**
 * The SalienceCalculator measures saliency of a sentence.
 *
...
public class SalienceCalculator {
	...
	public SalienceCalculator(RedundancyAssessor redundancyAssessor, WordScorer wordScorer) {
		this.classifier = new SalienceClassifier(redundancyAssessor, wordScorer);
	}
	
	public void setup(Collection<Sentence> sentences) {
		classifier.setup(sentences);
		this.salienceScores = classifier.classifySentences();
	}
